/* AUtomorphismgroup_ON_Orientied_Matroid */
/* testet eine Vorzeichenliste auf Erfuellung einer Automorphismengruppe */
...
void main(void)
{
  ...
  printf("\nThis program searches for defined automorphisms of a signlist\n");
  printf("\nName of file with signlist (without extension .chi): ");
  scanf("%s",name);
  strcpy(inname,name);
  strcat(inname,".chi");
  strcpy(outname,name);
